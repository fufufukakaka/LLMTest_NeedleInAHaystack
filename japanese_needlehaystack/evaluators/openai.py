...
class OpenAIEvaluator(Evaluator):
    ...
    def evaluate_responses_in_multi_needles(
        ...
        template = """あなたは参照情報を見ながら、生徒の回答に対して採点を行うことが得意な採点者です。
            ...
            一方で、生徒の回答が5つの情報を含んでいるが、そのうち2つが参照情報と一致していない場合、スコアは3となります。
            注意深く生徒の回答を見て、参照情報との一致度を評価してください。
            例えば、参照情報が「A,B」だったときに、生徒の回答が「A」だった場合、スコアは1となります。
            参照情報が「今期は予算カツカツで厳しいです, 500万円から経営会議にかけなきゃだめなんですよ,
            導入すればROIは立つとは思っています。」だったときに、生徒の回答が「今期は予算カツカツで厳しいです,
            500万円から経営会議にかけなきゃだめなんですよ」だった場合、スコアは2となります。
            注意深く生徒の回答を見て、参照情報との一致度を評価してください。
            生徒の回答: \n --- --- --- \n {answer}
            参照情報: \n --- --- --- \n {reference}"""
        # Prompt
